    ...
    return (
        <div className="min-h-screen bg-neutral-900 text-neutral-100 p-6 md:p-10 font-sans"> {/* Cải thiện padding tổng thể */}
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
                    ...
                    <div
                        ...
                        {blogs === null ? (
                            <div className="flex flex-col items-center justify-center h-48">
                                ...
                                <svg className="animate-spin h-8 w-8 text-neutral-400"
                            ...
                            <div className="flex flex-col items-center justify-center h-48 text-neutral-400">
                                ...
                                <img src="https://placehold.co/100x100/333333/999999?text=No+Blogs" alt="No Blogs"
                            ...
                            <div className="space-y-6">
                                {blogs.map((blog) => (
                                    ...
                                    >
                                        <div className="flex items-start gap-4 mb-4">
                                            ...
                                            {blog.featuredImage && (
                                                <img
                                                    ...
                                                    onError={(e) => {
                                                        ...
                                                        e.target.src = 'https://placehold.co/96x96/444444/DDDDDD?text=No+Image';
                                                    }}
                                                />
                                            )}
                                            <div className="flex-grow">
                                                <div className="flex justify-between items-start mb-1">
                                                    ...
                                                    <svg
                                                        className="w-5 h-5 text-neutral-400 group-hover:text-neutral-200 transition-colors flex-shrink-0"
                                        ...
                                        <div
                                            className="flex justify-between items-center text-xs text-neutral-400 border-t border-neutral-700 pt-3">
                                            {/* Hiển thị category nếu có */}
                                            {blog.category && <span
                                                className="px-3 py-1 bg-neutral-700 rounded-full text-neutral-300">#{blog.category}</span>}
                                            {/* Ngày đăng */}
                ...
                :
                    <div className="md:w-2/3 p-6 bg-neutral-800 rounded-lg shadow-xl border border-neutral-700">
                        <div className="flex justify-between items-center mb-6 border-b border-neutral-700 pb-3">
                            <h2 className="text-2xl font-bold text-neutral-50">My Blogs</h2>
                            {/* Nút quay lại */}
                            <button
                        ...
                        <p className="text-neutral-400">You do not have permission to access this section.</p>
                    </div>
                }
            </div>
        </div>
